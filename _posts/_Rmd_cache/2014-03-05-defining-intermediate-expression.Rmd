...
Interestly, also found that there's an [R function](http://www.inside-r.org/packages/cran/vegan/docs/MOStest) named after `r citet("10.2307/2409084")` to check if maximum or minimum of quadratic function is within studied interval.
