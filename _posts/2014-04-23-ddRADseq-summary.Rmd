...
total_dna <- conc_extraction/1000*40
...
plot(conc_extraction[1:6], conc_digestion[1:6])
```
...
Input 100 ng total DNA from each sample for ligation. 
...
plot(bioan_digestion[1:6], bioan_ligation[1:6])
```
